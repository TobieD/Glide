...
namespace gameProject
{
    ...
    public class Wheel : Enemy
    {
        ...
        {
           // m_windParticles.Draw(renderContext.GameTime);
           // m_windParticles.Direction = -1;

            renderContext.Graphics.GraphicsDevice.DepthStencilState = DepthStencilState.Default;
